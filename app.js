// let's break the given array of objects into multiple arrays then we will merge them together.
...
// let's do some mergeing
var obj3 = [
    ...obj1,
    ...obj2
]

//let's collect a div to store your data
var container  = document.getElementById("container");


// using foreach, this return same values as it gets
obj3.forEach((post, index, array) => {
    const {id, title, price, description, image_url} = post;
    return container.innerHTML += `<div class="col-md-4">
    <div id="id-${id}" class="card mt-3">
    <img src="${image_url}" class="card-img-top" alt="${title}" />
    <div class="card-body">
      <h5 class="card-title">${title}</h5>
      <p class="card-text">${description}</p>
      <p class="card-text" style="color:blue;font-weight:bold;">PKR ${price}.00</p>
